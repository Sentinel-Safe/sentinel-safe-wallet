pub const REQUIRED_SIGNATURES: u8 = 4;
pub const TOTAL_SIGNERS: u8 = 5;
pub const HUMAN_SIGNERS_COUNT: u8 = 2;
pub const AI_SIGNERS_COUNT: u8 = 3;
...
pub const SIGNATURE_COLLECTION_TIMEOUT_SECS: u64 = 3600;
